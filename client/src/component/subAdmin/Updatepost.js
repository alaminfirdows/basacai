...
import { getHomeDetails, updatepostSubAdmin, clearErrors } from "../../redux/action/homeAction"
...
function Updatepost({ history }) {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(updatepostSubAdmin(id, myForm))
    }
    ...
    useEffect(() => {
        ...
        if (isUpdated) {
            ...
            dispatch({ type: HomeConstats.UPDATE_POST_RESET })
        }
