...
function DashBoard() {
    const { homes, loading: homeLoading } = useSelector(state => state.allHomes)
    const { users, loading, error } = useSelector(state => state.users)
    const { news, loading: newsLoading } = useSelector(state => state.allNews)
                                ...
                                <div className="usersWrapper">
                                    {
                                        users && users.map((user) => (
                                            <div key={user._id} className="usersCard">
